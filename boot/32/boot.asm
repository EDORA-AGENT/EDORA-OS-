...
load_kernel_chs:
    ; Compatibility fallback for BIOSes without INT 13h extensions.
    xor ax, ax
    mov es, ax
...
kernel_loaded:
    ...
    ; Force a short delay to allow BIOS to finish the transfer
    mov cx, 0x0100
.delay_loop:
    dec cx
    jnz .delay_loop
...
protected_mode:
    ...
    ; Explicit far jump to flat 32-bit code segment.
    db 0xEA
    dd 0x10000
    dw 0x08
